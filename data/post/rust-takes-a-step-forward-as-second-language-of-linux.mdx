---
title: Rust takes a step forward as second language of Linux
date: '2022-07-02'
tags: ['random']
...
According to Stack Overflow Developer Survey 2022, Rust is shown to be the most loved programming language, with the percentage of dreaded responses only about 13%. 2022 marks Rust is on its seventh year as the most loved one.
