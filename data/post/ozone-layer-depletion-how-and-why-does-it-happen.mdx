---
title: Ozone layer depletion - How and why does it happen?
date: '2022-01-26'
tags: ['science']
...
Firstly, you need to know that CFCs don't react to other substances smoothly. The only condition to make them break up is under sunlight, which causes the release of chlorine diverging their molecules. Once chlorine is extricated, it'll react with ozone to form chlorine monoxide and oxygen.
...
When the coolant is used in old refrigerators, air conditioners, and other machines aren’t accurately disposed of, it leaks CFCs into the atmosphere as the liquid evaporates.
...
Notwithstanding, because being inert compounds, CFCs can persist in the stratosphere for 20 to 100 years; therefore, the damage was done in the previous century still impacts the environment. According to researchers, to make ozone levels back to the state of 1980, we need to wait for at least the next three decades.
